...
- 🚀 **Blazing Fast**: Built on Redis with optimized graph operations
- 🔗 **Cypher Support**: Use the powerful Cypher query language
- 🧠 **LLM Integration**: Seamless integration with LangChain's QA chains
